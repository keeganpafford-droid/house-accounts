...
const SRC = [
  ...
  extractLines('signal-layer-label', 4245, 4255, 'function signalLayerLabel(opp){', '}'),
  extractLines('is-likely-invalid-account-name', 4229, 4236, 'function isLikelyInvalidAccountName(name){', '}'),
  extractLines('parse-maybe-date', 4281, 4286, 'function parseMaybeDate(value){', '}'),
  extractLines('parse-csv', 4002, 4120, 'function parseCSV(text){', '}'),
  extractLines('infer-promo-category', 4122, 4142, 'function inferPromoCategory(text){', '}'),
  extractLines('infer-industry', 4144, 4152, 'function inferIndustry(client, projects){', '}'),
  ...
  extractLines('format-short-date', 4712, 4716, 'function formatShortDate(value){', '}'),
  extractLines('account-history-status', 4747, 4812, 'function isAccountHistoryOpportunity(opp){', '}'),
  extractLines('opportunity-generation', 6384, 6924, 'function estimateFutureValue(account, opportunityType){', '}'),
  extractLines('order-history-filters', 7709, 7737, 'function isClosedHistoricalRecord(record){', '}'),
  extractLines('normalize-signal-layer-type', 7756, 7762, 'function normalizeSignalLayerType(type){', '}'),
  extractLines('recommendation-type', 7774, 7873, 'function daysSinceDate(value){', '}'),
  extractLines('opportunity-scoring', 7875, 7946, 'function calculateOpportunityScore(opp){', '}'),
  extractLines('timebox-classification', 8073, 8129, 'function monthIndexFromName(name){', '}'),
  ...
  extractLines('sales-play-account-history-grounding', 6926, 7454, 'function cleanSalesPlayText(value){', '}')
].join('\n\n');
