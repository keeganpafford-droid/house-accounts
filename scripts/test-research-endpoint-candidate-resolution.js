...
const REQUIRE_RESOLVED_CANDIDATE_SRC = extractLines(RESEARCH_BATCH_PATH, 'requireResolvedCandidate', 2420, 2423, 'function requireResolvedCandidate(candidates, mapped, account) {');
const batchSandbox = {};
