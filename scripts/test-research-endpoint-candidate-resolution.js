...
const REQUIRE_RESOLVED_CANDIDATE_SRC = extractLines(RESEARCH_BATCH_PATH, 'requireResolvedCandidate', 2342, 2345, 'function requireResolvedCandidate(candidates, mapped, account) {');
const batchSandbox = {};
...
const RESOLVE_ACCOUNT_CANDIDATE_SRC = extractLines(RESEARCH_ACCOUNT_PATH, 'resolveAccountCandidate', 1194, 1197, 'function resolveAccountCandidate(candidates, sourceUrl) {');
