...
const REQUIRE_RESOLVED_CANDIDATE_SRC = extractLines(RESEARCH_BATCH_PATH, 'requireResolvedCandidate', 2052, 2055, 'function requireResolvedCandidate(candidates, mapped, account) {');
const batchSandbox = {};
...
const RESOLVE_ACCOUNT_CANDIDATE_SRC = extractLines(RESEARCH_ACCOUNT_PATH, 'resolveAccountCandidate', 1150, 1153, 'function resolveAccountCandidate(candidates, sourceUrl) {');
