...
// ---------------------------------------------------------------------------
const safeParseSrc = extractLines('safeParseResearchResponse', 6032, 6067, 'async function safeParseResearchResponse(res, context){');
assert(
...
const researchAccountModalSrc = extractLines('researchAccountFromManageModal', 6069, 6207, 'async function researchAccountFromManageModal(accountName, listId){');
assert(
...
const researchListModalSrc = extractLines('researchListFromManageModal', 6222, 6390, 'async function researchListFromManageModal(listId){');
assert(
...
const processDataSrc = extractLines('processData', 9929, 10144, 'function processData(records){');
assert(
