...
// ---------------------------------------------------------------------------
const safeParseSrc = extractLines('safeParseResearchResponse', 6547, 6582, 'async function safeParseResearchResponse(res, context){');
assert(
...
const researchAccountModalSrc = extractLines('researchAccountFromManageModal', 6584, 6747, 'async function researchAccountFromManageModal(accountName, listId){');
assert(
...
const researchListModalSrc = extractLines('researchListFromManageModal', 6762, 6992, 'async function researchListFromManageModal(listId, options = {}){');
assert(
...
const processDataSrc = extractLines('processData', 10960, 11188, 'function processData(records){');
assert(
...
// ---------------------------------------------------------------------------
const handleListResearchClickSrc = extractLines('handleListResearchClick', 11883, 11995, 'async function handleListResearchClick(btn){');
assert(
