...
// ---------------------------------------------------------------------------
const isHelpRelatedSrc = extractLines('isHelpRelatedGuidedTourTrigger', 4184, 4187, 'function isHelpRelatedGuidedTourTrigger(el){');
assert(
...
const launchGuidedTourSrc = extractLines('launchGuidedTour', 4189, 4222, 'function launchGuidedTour(){');
assert(
...
const closeGuidedTourSrc = extractLines('closeGuidedTour', 4224, 4268, 'function closeGuidedTour(){');
assert(
...
// ---------------------------------------------------------------------------
const safeParseSrc = extractLines('safeParseResearchResponse', 6532, 6567, 'async function safeParseResearchResponse(res, context){');
assert(
...
const researchAccountModalSrc = extractLines('researchAccountFromManageModal', 6569, 6732, 'async function researchAccountFromManageModal(accountName, listId){');
assert(
...
const researchListModalSrc = extractLines('researchListFromManageModal', 6747, 6977, 'async function researchListFromManageModal(listId, options = {}){');
assert(
...
// ---------------------------------------------------------------------------
const buildingPlaceholderSrc = extractLines('showBuildingDashboardPanelPlaceholder', 3705, 3716, 'function showBuildingDashboardPanelPlaceholder(){');
assert(
...
const fetchAggregateSrc = extractLines('fetchAndRenderAggregateDashboard', 3757, 3862, "async function fetchAndRenderAggregateDashboard(email, {silent = false} = {}){");
assert(
...
const processDataSrc = extractLines('processData', 10945, 11173, 'function processData(records){');
assert(
...
const retryStateSrc = extractLines('showDashboardRefreshRetryState', 3723, 3743, 'function showDashboardRefreshRetryState(){');
assert(
...
// ---------------------------------------------------------------------------
const handleListResearchClickSrc = extractLines('handleListResearchClick', 11868, 11980, 'async function handleListResearchClick(btn){');
assert(
