...
// ---------------------------------------------------------------------------
const isHelpRelatedSrc = extractLines('isHelpRelatedGuidedTourTrigger', 4206, 4209, 'function isHelpRelatedGuidedTourTrigger(el){');
assert(
...
const launchGuidedTourSrc = extractLines('launchGuidedTour', 4211, 4244, 'function launchGuidedTour(){');
assert(
...
const closeGuidedTourSrc = extractLines('closeGuidedTour', 4246, 4290, 'function closeGuidedTour(){');
assert(
...
// ---------------------------------------------------------------------------
const safeParseSrc = extractLines('safeParseResearchResponse', 6576, 6611, 'async function safeParseResearchResponse(res, context){');
assert(
...
const researchAccountModalSrc = extractLines('researchAccountFromManageModal', 6613, 6776, 'async function researchAccountFromManageModal(accountName, listId){');
assert(
...
const researchListModalSrc = extractLines('researchListFromManageModal', 6791, 7021, 'async function researchListFromManageModal(listId, options = {}){');
assert(
...
// ---------------------------------------------------------------------------
const buildingPlaceholderSrc = extractLines('showBuildingDashboardPanelPlaceholder', 3727, 3738, 'function showBuildingDashboardPanelPlaceholder(){');
assert(
...
const fetchAggregateSrc = extractLines('fetchAndRenderAggregateDashboard', 3779, 3884, "async function fetchAndRenderAggregateDashboard(email, {silent = false} = {}){");
assert(
...
const processDataSrc = extractLines('processData', 10995, 11223, 'function processData(records){');
assert(
...
const retryStateSrc = extractLines('showDashboardRefreshRetryState', 3745, 3765, 'function showDashboardRefreshRetryState(){');
assert(
...
// ---------------------------------------------------------------------------
const handleListResearchClickSrc = extractLines('handleListResearchClick', 11918, 12030, 'async function handleListResearchClick(btn){');
assert(
