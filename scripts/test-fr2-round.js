...
// ---------------------------------------------------------------------------
const safeParseSrc = extractLines('safeParseResearchResponse', 5672, 5707, 'async function safeParseResearchResponse(res, context){');
assert(
...
const researchAccountModalSrc = extractLines('researchAccountFromManageModal', 5709, 5837, 'async function researchAccountFromManageModal(accountName, listId){');
assert(
...
const researchListModalSrc = extractLines('researchListFromManageModal', 5852, 5972, 'async function researchListFromManageModal(listId){');
assert(
...
const processDataSrc = extractLines('processData', 9305, 9520, 'function processData(records){');
assert(
