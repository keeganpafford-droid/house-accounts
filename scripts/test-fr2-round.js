...
// ---------------------------------------------------------------------------
const safeParseSrc = extractLines('safeParseResearchResponse', 5802, 5837, 'async function safeParseResearchResponse(res, context){');
assert(
...
const researchAccountModalSrc = extractLines('researchAccountFromManageModal', 5839, 5977, 'async function researchAccountFromManageModal(accountName, listId){');
assert(
...
const researchListModalSrc = extractLines('researchListFromManageModal', 5992, 6160, 'async function researchListFromManageModal(listId){');
assert(
...
const processDataSrc = extractLines('processData', 9632, 9847, 'function processData(records){');
assert(
