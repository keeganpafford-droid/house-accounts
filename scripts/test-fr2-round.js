...
// ---------------------------------------------------------------------------
const isHelpRelatedSrc = extractLines('isHelpRelatedGuidedTourTrigger', 4173, 4176, 'function isHelpRelatedGuidedTourTrigger(el){');
assert(
...
const launchGuidedTourSrc = extractLines('launchGuidedTour', 4178, 4211, 'function launchGuidedTour(){');
assert(
...
const closeGuidedTourSrc = extractLines('closeGuidedTour', 4213, 4257, 'function closeGuidedTour(){');
assert(
...
// ---------------------------------------------------------------------------
const safeParseSrc = extractLines('safeParseResearchResponse', 6501, 6536, 'async function safeParseResearchResponse(res, context){');
assert(
...
const researchAccountModalSrc = extractLines('researchAccountFromManageModal', 6538, 6701, 'async function researchAccountFromManageModal(accountName, listId){');
assert(
...
const researchListModalSrc = extractLines('researchListFromManageModal', 6716, 6946, 'async function researchListFromManageModal(listId, options = {}){');
assert(
...
// ---------------------------------------------------------------------------
const buildingPlaceholderSrc = extractLines('showBuildingDashboardPanelPlaceholder', 3694, 3705, 'function showBuildingDashboardPanelPlaceholder(){');
assert(
...
const fetchAggregateSrc = extractLines('fetchAndRenderAggregateDashboard', 3746, 3851, "async function fetchAndRenderAggregateDashboard(email, {silent = false} = {}){");
assert(
...
const retryStateSrc = extractLines('showDashboardRefreshRetryState', 3712, 3732, 'function showDashboardRefreshRetryState(){');
assert(
