...
const CARD_AND_MODAL_BLOCK = extractBlock('card-and-modal-helpers', 4337, 5231, 'function confidenceLabel(');
...
const DEDUPE_AND_IDENTITY_BLOCK = extractBlock('dedupe-and-identity-helpers', 2779, 3197, 'function cleanOpportunityToken(');
...
const SALES_PLAY_BLOCK = extractBlock('sales-play-grounding', 6635, 7763, 'function salesPlayModeFromOpp(');
...
const SCORING_AND_TIMEBOX_BLOCK = extractBlock('scoring-and-timebox-helpers', 7880, 8383, 'function normalizeSignalLayerType(');

const TIMEBOX_CONFIG_SRC = extractBlock('TIMEBOX_CONFIG', 2626, 2631, 'const TIMEBOX_CONFIG = {');
const IS_RELATIONSHIP_EXPANSION_SRC = extractBlock('isRelationshipExpansionOpportunity', 2861, 2864, 'function isRelationshipExpansionOpportunity(');
const ESCAPE_HTML_SRC = extractBlock('escapeHtml', 9034, 9037, 'function escapeHtml(');
const FMT_MONEY_SRC = extractBlock('fmtMoney', 6550, 6552, 'function fmtMoney(');
const CLAMP_SCORE_SRC = extractBlock('clampScore', 6555, 6557, 'function clampScore(');
...
const FORMAT_DASHBOARD_SCAN_DATE_SRC = extractBlock('formatDashboardScanDate', 2756, 2761, 'function formatDashboardScanDate(');
const UNIQUE_DASHBOARD_OPPORTUNITIES_SRC = extractBlock('uniqueDashboardOpportunities', 2763, 2776, 'function uniqueDashboardOpportunities(');
const NEWLY_DETECTED_COUNT_SRC = extractBlock('newlyDetectedCount', 3231, 3233, 'function newlyDetectedCount(');
const RENDER_CUSTOMER_DASHBOARD_SRC = extractBlock('renderCustomerDashboard', 3255, 3282, 'function renderCustomerDashboard(');
...
const SHOW_CUSTOMER_DASHBOARD_PANEL_SRC = extractBlock('showCustomerDashboardPanel', 3242, 3253, 'function showCustomerDashboardPanel(');
