...
const NEWLY_DETECTED_COUNT_SRC = extractBlock('newlyDetectedCount', 3440, 3442, 'function newlyDetectedCount(');
const RENDER_CUSTOMER_DASHBOARD_SRC = extractBlock('renderCustomerDashboard', 3464, 3491, 'function renderCustomerDashboard(');
...
const SHOW_CUSTOMER_DASHBOARD_PANEL_SRC = extractBlock('showCustomerDashboardPanel', 3451, 3462, 'function showCustomerDashboardPanel(');
