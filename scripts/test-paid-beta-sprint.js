...
const CARD_AND_MODAL_BLOCK = extractBlock('card-and-modal-helpers', 4402, 5296, 'function confidenceLabel(');
...
const SALES_PLAY_BLOCK = extractBlock('sales-play-grounding', 6917, 8059, 'function salesPlayModeFromOpp(');
...
const SCORING_AND_TIMEBOX_BLOCK = extractBlock('scoring-and-timebox-helpers', 8176, 8679, 'function normalizeSignalLayerType(');
...
const ESCAPE_HTML_SRC = extractBlock('escapeHtml', 9345, 9348, 'function escapeHtml(');
const FMT_MONEY_SRC = extractBlock('fmtMoney', 6832, 6834, 'function fmtMoney(');
const CLAMP_SCORE_SRC = extractBlock('clampScore', 6837, 6839, 'function clampScore(');
