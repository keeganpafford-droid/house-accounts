...
const NEWLY_DETECTED_COUNT_SRC = extractBlock('newlyDetectedCount', 3287, 3289, 'function newlyDetectedCount(');
const RENDER_CUSTOMER_DASHBOARD_SRC = extractBlock('renderCustomerDashboard', 3311, 3338, 'function renderCustomerDashboard(');
...
const SHOW_CUSTOMER_DASHBOARD_PANEL_SRC = extractBlock('showCustomerDashboardPanel', 3298, 3309, 'function showCustomerDashboardPanel(');
