...
const REAL_SOURCE = [
  ...
  extractFn('fetchUploadScopedSnapshot', 4025, 4047, {async: true}),
  extractFn('persistScopedResearchResult', 4055, 4100, {async: true}),
  extractFn('researchAccountFromManageModal', 4150, 4254, {async: true}),
  extractFn('researchAccountByName', 4274, 4414, {async: true}),
  extractFn('getAccountsForResearch', 4419, 4432),
  extractFn('batchPayloadForAccounts', 4434, 4478),
  extractFn('applyBusinessSignalAccountBoost', 4481, 4489),
  extractFn('researchAccountsBatch', 4491, 4580, {async: true}),
  extractFn('signalTopicKeyClient', 4582, 4590),
  extractFn('dedupeSignalsClient', 4592, 4605),
  extractFn('researchTopAccounts', 4607, 4737, {async: true}),
  extractFn('refreshOpportunityViews', 4838, 4858),
  extractFn('renderDetailedAccountViews', 6496, 6564),
  extractFn('serializeAccountForStorage', 6574, 6633),
  extractFn('performSaveCurrentUpload', 6643, 6743, {async: true}),
  extractFn('saveCurrentUpload', 6752, 6756),
  extractFn('toggleAccountMetadataEdit', 6764, 6770),
  extractFn('saveAccountMetadataEdit', 6793, 6829, {async: true}),
  extractRaw('delegatedClickListener', 6847, 6869, "document.addEventListener('click', (event) => {"),
  extractFn('importedContactsFromRecords', 6882, 6898),
