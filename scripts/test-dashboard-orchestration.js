...
const REAL_SOURCE = [
  ...
  extractFn('fetchUploadScopedSnapshot', 4627, 4649, {async: true}),
  extractFn('persistScopedResearchResult', 4657, 4702, {async: true}),
  extractFn('researchAccountFromManageModal', 4752, 4856, {async: true}),
  extractFn('researchAccountByName', 4876, 5016, {async: true}),
  extractFn('getAccountsForResearch', 5021, 5034),
  extractFn('batchPayloadForAccounts', 5036, 5080),
  extractFn('applyBusinessSignalAccountBoost', 5083, 5091),
  extractFn('researchAccountsBatch', 5093, 5182, {async: true}),
  extractFn('signalTopicKeyClient', 5184, 5192),
  extractFn('dedupeSignalsClient', 5194, 5207),
  extractFn('researchTopAccounts', 5209, 5339, {async: true}),
  extractFn('refreshOpportunityViews', 5440, 5460),
  extractFn('renderDetailedAccountViews', 7578, 7646),
  extractFn('serializeAccountForStorage', 7656, 7715),
  extractFn('performSaveCurrentUpload', 7725, 7825, {async: true}),
  extractFn('saveCurrentUpload', 7834, 7838),
  extractFn('toggleAccountMetadataEdit', 7846, 7852),
  extractFn('saveAccountMetadataEdit', 7875, 7911, {async: true}),
  extractRaw('delegatedClickListener', 7929, 7951, "document.addEventListener('click', (event) => {"),
  extractFn('importedContactsFromRecords', 7964, 7980),
