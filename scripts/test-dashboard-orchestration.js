...
const REAL_SOURCE = [
  ...
  extractFn('accountCardFor', 3411, 3413),
  extractFn('accountSignalsPanel', 3414, 3417),
  extractFn('fetchUploadScopedSnapshot', 4214, 4236, {async: true}),
  extractFn('persistScopedResearchResult', 4244, 4289, {async: true}),
  extractFn('researchAccountFromManageModal', 4339, 4443, {async: true}),
  extractFn('researchAccountByName', 4463, 4603, {async: true}),
  extractFn('getAccountsForResearch', 4608, 4621),
  extractFn('batchPayloadForAccounts', 4623, 4667),
  extractFn('applyBusinessSignalAccountBoost', 4670, 4678),
  extractFn('researchAccountsBatch', 4680, 4769, {async: true}),
  extractFn('signalTopicKeyClient', 4771, 4779),
  extractFn('dedupeSignalsClient', 4781, 4794),
  extractFn('researchTopAccounts', 4796, 4926, {async: true}),
  extractFn('refreshOpportunityViews', 5027, 5047),
  extractFn('renderDetailedAccountViews', 6766, 6834),
  extractFn('serializeAccountForStorage', 6844, 6903),
  extractFn('performSaveCurrentUpload', 6913, 7013, {async: true}),
  extractFn('saveCurrentUpload', 7022, 7026),
  extractFn('toggleAccountMetadataEdit', 7034, 7040),
  extractFn('saveAccountMetadataEdit', 7063, 7099, {async: true}),
  extractRaw('delegatedClickListener', 7117, 7139, "document.addEventListener('click', (event) => {"),
  extractFn('importedContactsFromRecords', 7152, 7168),
