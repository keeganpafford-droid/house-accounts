...
const REAL_SOURCE = [
  ...
  extractFn('accountCardFor', 3513, 3515),
  extractFn('accountSignalsPanel', 3516, 3519),
  extractFn('fetchUploadScopedSnapshot', 4446, 4468, {async: true}),
  extractFn('persistScopedResearchResult', 4476, 4521, {async: true}),
  extractFn('researchAccountFromManageModal', 4571, 4675, {async: true}),
  extractFn('researchAccountByName', 4695, 4835, {async: true}),
  extractFn('getAccountsForResearch', 4840, 4853),
  extractFn('batchPayloadForAccounts', 4855, 4899),
  extractFn('applyBusinessSignalAccountBoost', 4902, 4910),
  extractFn('researchAccountsBatch', 4912, 5001, {async: true}),
  extractFn('signalTopicKeyClient', 5003, 5011),
  extractFn('dedupeSignalsClient', 5013, 5026),
  extractFn('researchTopAccounts', 5028, 5158, {async: true}),
  extractFn('refreshOpportunityViews', 5259, 5279),
  extractFn('renderDetailedAccountViews', 7153, 7221),
  extractFn('serializeAccountForStorage', 7231, 7290),
  extractFn('performSaveCurrentUpload', 7300, 7400, {async: true}),
  extractFn('saveCurrentUpload', 7409, 7413),
  extractFn('toggleAccountMetadataEdit', 7421, 7427),
  extractFn('saveAccountMetadataEdit', 7450, 7486, {async: true}),
  extractRaw('delegatedClickListener', 7504, 7526, "document.addEventListener('click', (event) => {"),
  extractFn('importedContactsFromRecords', 7539, 7555),
