...
const REAL_SOURCE = [
  ...
  extractFn('accountCardFor', 3549, 3551),
  extractFn('accountSignalsPanel', 3552, 3555),
  extractFn('fetchUploadScopedSnapshot', 4506, 4528, {async: true}),
  extractFn('persistScopedResearchResult', 4536, 4581, {async: true}),
  extractFn('researchAccountFromManageModal', 4631, 4735, {async: true}),
  extractFn('researchAccountByName', 4755, 4895, {async: true}),
  extractFn('getAccountsForResearch', 4900, 4913),
  extractFn('batchPayloadForAccounts', 4915, 4959),
  extractFn('applyBusinessSignalAccountBoost', 4962, 4970),
  extractFn('researchAccountsBatch', 4972, 5061, {async: true}),
  extractFn('signalTopicKeyClient', 5063, 5071),
  extractFn('dedupeSignalsClient', 5073, 5086),
  extractFn('researchTopAccounts', 5088, 5218, {async: true}),
  extractFn('refreshOpportunityViews', 5319, 5339),
  extractFn('renderDetailedAccountViews', 7240, 7308),
  extractFn('serializeAccountForStorage', 7318, 7377),
  extractFn('performSaveCurrentUpload', 7387, 7487, {async: true}),
  extractFn('saveCurrentUpload', 7496, 7500),
  extractFn('toggleAccountMetadataEdit', 7508, 7514),
  extractFn('saveAccountMetadataEdit', 7537, 7573, {async: true}),
  extractRaw('delegatedClickListener', 7591, 7613, "document.addEventListener('click', (event) => {"),
  extractFn('importedContactsFromRecords', 7626, 7642),
