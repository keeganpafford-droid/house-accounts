...
const REAL_SOURCE = [
  ...
  extractFn('accountCardFor', 3562, 3564),
  extractFn('accountSignalsPanel', 3565, 3568),
  extractFn('fetchUploadScopedSnapshot', 4519, 4541, {async: true}),
  extractFn('persistScopedResearchResult', 4549, 4594, {async: true}),
  extractFn('researchAccountFromManageModal', 4644, 4748, {async: true}),
  extractFn('researchAccountByName', 4768, 4908, {async: true}),
  extractFn('getAccountsForResearch', 4913, 4926),
  extractFn('batchPayloadForAccounts', 4928, 4972),
  extractFn('applyBusinessSignalAccountBoost', 4975, 4983),
  extractFn('researchAccountsBatch', 4985, 5074, {async: true}),
  extractFn('signalTopicKeyClient', 5076, 5084),
  extractFn('dedupeSignalsClient', 5086, 5099),
  extractFn('researchTopAccounts', 5101, 5231, {async: true}),
  extractFn('refreshOpportunityViews', 5332, 5352),
  extractFn('renderDetailedAccountViews', 7253, 7321),
  extractFn('serializeAccountForStorage', 7331, 7390),
  extractFn('performSaveCurrentUpload', 7400, 7500, {async: true}),
  extractFn('saveCurrentUpload', 7509, 7513),
  extractFn('toggleAccountMetadataEdit', 7521, 7527),
  extractFn('saveAccountMetadataEdit', 7550, 7586, {async: true}),
  extractRaw('delegatedClickListener', 7604, 7626, "document.addEventListener('click', (event) => {"),
  extractFn('importedContactsFromRecords', 7639, 7655),
