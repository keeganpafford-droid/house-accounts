...
const REAL_SOURCE = [
  extractFn('claimAutomaticResearchRun', 2239, 2249, {async: true}),
  extractFn('heartbeatCurrentResearchRun', 2269, 2286, {async: true}),
  extractFn('reportResearchRunOutcome', 2300, 2325, {async: true}),
  extractFn('normalizeSavedAccount', 2441, 2503),
  extractFn('accountCardFor', 3577, 3579),
  extractFn('accountSignalsPanel', 3580, 3583),
  extractFn('fetchUploadScopedSnapshot', 4639, 4661, {async: true}),
  extractFn('persistScopedResearchResult', 4669, 4714, {async: true}),
  extractFn('researchAccountFromManageModal', 4764, 4868, {async: true}),
  extractFn('researchAccountByName', 4888, 5028, {async: true}),
  extractFn('getAccountsForResearch', 5033, 5046),
  extractFn('batchPayloadForAccounts', 5048, 5092),
  extractFn('applyBusinessSignalAccountBoost', 5095, 5103),
  extractFn('researchAccountsBatch', 5105, 5194, {async: true}),
  extractFn('signalTopicKeyClient', 5196, 5204),
  extractFn('dedupeSignalsClient', 5206, 5219),
  extractFn('researchTopAccounts', 5221, 5351, {async: true}),
  extractFn('refreshOpportunityViews', 5452, 5472),
  extractFn('renderDetailedAccountViews', 7626, 7694),
  extractFn('serializeAccountForStorage', 7704, 7763),
  extractFn('performSaveCurrentUpload', 7773, 7873, {async: true}),
  extractFn('saveCurrentUpload', 7882, 7886),
  extractFn('toggleAccountMetadataEdit', 7894, 7900),
  extractFn('saveAccountMetadataEdit', 7923, 7959, {async: true}),
  extractRaw('delegatedClickListener', 7977, 7999, "document.addEventListener('click', (event) => {"),
  extractFn('importedContactsFromRecords', 8012, 8028),
