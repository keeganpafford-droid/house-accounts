...
const REAL_SOURCE = [
  ...
  extractFn('accountCardFor', 3488, 3490),
  extractFn('accountSignalsPanel', 3491, 3494),
  extractFn('fetchUploadScopedSnapshot', 4398, 4420, {async: true}),
  extractFn('persistScopedResearchResult', 4428, 4473, {async: true}),
  extractFn('researchAccountFromManageModal', 4523, 4627, {async: true}),
  extractFn('researchAccountByName', 4647, 4787, {async: true}),
  extractFn('getAccountsForResearch', 4792, 4805),
  extractFn('batchPayloadForAccounts', 4807, 4851),
  extractFn('applyBusinessSignalAccountBoost', 4854, 4862),
  extractFn('researchAccountsBatch', 4864, 4953, {async: true}),
  extractFn('signalTopicKeyClient', 4955, 4963),
  extractFn('dedupeSignalsClient', 4965, 4978),
  extractFn('researchTopAccounts', 4980, 5110, {async: true}),
  extractFn('refreshOpportunityViews', 5211, 5231),
  extractFn('renderDetailedAccountViews', 7097, 7165),
  extractFn('serializeAccountForStorage', 7175, 7234),
  extractFn('performSaveCurrentUpload', 7244, 7344, {async: true}),
  extractFn('saveCurrentUpload', 7353, 7357),
  extractFn('toggleAccountMetadataEdit', 7365, 7371),
  extractFn('saveAccountMetadataEdit', 7394, 7430, {async: true}),
  extractRaw('delegatedClickListener', 7448, 7470, "document.addEventListener('click', (event) => {"),
  extractFn('importedContactsFromRecords', 7483, 7499),
