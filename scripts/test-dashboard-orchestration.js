...
const REAL_SOURCE = [
  extractFn('claimAutomaticResearchRun', 2393, 2403, {async: true}),
  extractFn('heartbeatCurrentResearchRun', 2423, 2440, {async: true}),
  extractFn('reportResearchRunOutcome', 2454, 2479, {async: true}),
  extractFn('normalizeSavedAccount', 2595, 2657),
  extractFn('accountCardFor', 4009, 4011),
  extractFn('accountSignalsPanel', 4012, 4015),
  extractFn('fetchUploadScopedSnapshot', 5071, 5093, {async: true}),
  extractFn('persistScopedResearchResult', 5101, 5146, {async: true}),
  extractFn('researchAccountFromManageModal', 5196, 5300, {async: true}),
  extractFn('researchAccountByName', 5320, 5460, {async: true}),
  extractFn('getAccountsForResearch', 5465, 5478),
  extractFn('batchPayloadForAccounts', 5480, 5524),
  extractFn('applyBusinessSignalAccountBoost', 5527, 5535),
  extractFn('researchAccountsBatch', 5537, 5626, {async: true}),
  extractFn('signalTopicKeyClient', 5628, 5636),
  extractFn('dedupeSignalsClient', 5638, 5651),
  extractFn('researchTopAccounts', 5653, 5783, {async: true}),
  extractFn('refreshOpportunityViews', 5884, 5904),
  extractFn('renderDetailedAccountViews', 8058, 8126),
  extractFn('serializeAccountForStorage', 8136, 8195),
  extractFn('performSaveCurrentUpload', 8205, 8305, {async: true}),
  extractFn('saveCurrentUpload', 8314, 8318),
  extractFn('toggleAccountMetadataEdit', 8326, 8332),
  extractFn('saveAccountMetadataEdit', 8355, 8391, {async: true}),
  extractRaw('delegatedClickListener', 8409, 8431, "document.addEventListener('click', (event) => {"),
  extractFn('importedContactsFromRecords', 8444, 8460),
