...
const REAL_SOURCE = [
  ...
  extractFn('accountCardFor', 3526, 3528),
  extractFn('accountSignalsPanel', 3529, 3532),
  extractFn('fetchUploadScopedSnapshot', 4466, 4488, {async: true}),
  extractFn('persistScopedResearchResult', 4496, 4541, {async: true}),
  extractFn('researchAccountFromManageModal', 4591, 4695, {async: true}),
  extractFn('researchAccountByName', 4715, 4855, {async: true}),
  extractFn('getAccountsForResearch', 4860, 4873),
  extractFn('batchPayloadForAccounts', 4875, 4919),
  extractFn('applyBusinessSignalAccountBoost', 4922, 4930),
  extractFn('researchAccountsBatch', 4932, 5021, {async: true}),
  extractFn('signalTopicKeyClient', 5023, 5031),
  extractFn('dedupeSignalsClient', 5033, 5046),
  extractFn('researchTopAccounts', 5048, 5178, {async: true}),
  extractFn('refreshOpportunityViews', 5279, 5299),
  extractFn('renderDetailedAccountViews', 7173, 7241),
  extractFn('serializeAccountForStorage', 7251, 7310),
  extractFn('performSaveCurrentUpload', 7320, 7420, {async: true}),
  extractFn('saveCurrentUpload', 7429, 7433),
  extractFn('toggleAccountMetadataEdit', 7441, 7447),
  extractFn('saveAccountMetadataEdit', 7470, 7506, {async: true}),
  extractRaw('delegatedClickListener', 7524, 7546, "document.addEventListener('click', (event) => {"),
  extractFn('importedContactsFromRecords', 7559, 7575),
