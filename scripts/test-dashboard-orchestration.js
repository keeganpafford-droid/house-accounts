...
const REAL_SOURCE = [
  extractFn('claimAutomaticResearchRun', 2221, 2231, {async: true}),
  extractFn('heartbeatCurrentResearchRun', 2251, 2268, {async: true}),
  extractFn('reportResearchRunOutcome', 2282, 2307, {async: true}),
  extractFn('normalizeSavedAccount', 2423, 2485),
  extractFn('accountCardFor', 3268, 3270),
  extractFn('accountSignalsPanel', 3271, 3274),
  extractFn('fetchUploadScopedSnapshot', 4040, 4062, {async: true}),
  extractFn('persistScopedResearchResult', 4070, 4115, {async: true}),
  extractFn('researchAccountFromManageModal', 4165, 4269, {async: true}),
  extractFn('researchAccountByName', 4289, 4429, {async: true}),
  extractFn('getAccountsForResearch', 4434, 4447),
  extractFn('batchPayloadForAccounts', 4449, 4493),
  extractFn('applyBusinessSignalAccountBoost', 4496, 4504),
  extractFn('researchAccountsBatch', 4506, 4595, {async: true}),
  extractFn('signalTopicKeyClient', 4597, 4605),
  extractFn('dedupeSignalsClient', 4607, 4620),
  extractFn('researchTopAccounts', 4622, 4752, {async: true}),
  extractFn('refreshOpportunityViews', 4853, 4873),
  extractFn('renderDetailedAccountViews', 6523, 6591),
  extractFn('serializeAccountForStorage', 6601, 6660),
  extractFn('performSaveCurrentUpload', 6670, 6770, {async: true}),
  extractFn('saveCurrentUpload', 6779, 6783),
  extractFn('toggleAccountMetadataEdit', 6791, 6797),
  extractFn('saveAccountMetadataEdit', 6820, 6856, {async: true}),
  extractRaw('delegatedClickListener', 6874, 6896, "document.addEventListener('click', (event) => {"),
  extractFn('importedContactsFromRecords', 6909, 6925),
