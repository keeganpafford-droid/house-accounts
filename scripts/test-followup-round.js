...
// instead.
const listCardSrc = extractLines('listCard', 11174, 11214, 'function listCard(list){');
assert(
...
// ---------------------------------------------------------------------------
const researchListSrc = extractLines('researchListFromManageModal', 6527, 6753, 'async function researchListFromManageModal(listId, options = {}){');
assert(
...
// the rest.
// ---------------------------------------------------------------------------
const openResearchedSrc = extractLines('openResearchedAccountOpportunities', 7834, 7929, 'async function openResearchedAccountOpportunities(uploadId, accountName){');
assert(
