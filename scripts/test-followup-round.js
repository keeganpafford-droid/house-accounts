...
// instead.
const listCardSrc = extractLines('listCard', 11561, 11601, 'function listCard(list){');
assert(
...
// ---------------------------------------------------------------------------
const researchListSrc = extractLines('researchListFromManageModal', 6747, 6977, 'async function researchListFromManageModal(listId, options = {}){');
assert(
...
// the rest.
// ---------------------------------------------------------------------------
const openResearchedSrc = extractLines('openResearchedAccountOpportunities', 8107, 8207, 'async function openResearchedAccountOpportunities(uploadId, accountName){');
assert(
