...
// instead.
const listCardSrc = extractLines('listCard', 11576, 11616, 'function listCard(list){');
assert(
...
// ---------------------------------------------------------------------------
const researchListSrc = extractLines('researchListFromManageModal', 6762, 6992, 'async function researchListFromManageModal(listId, options = {}){');
assert(
...
// the rest.
// ---------------------------------------------------------------------------
const openResearchedSrc = extractLines('openResearchedAccountOpportunities', 8122, 8222, 'async function openResearchedAccountOpportunities(uploadId, accountName){');
assert(
