...
// instead.
const listCardSrc = extractLines('listCard', 11470, 11510, 'function listCard(list){');
assert(
...
// ---------------------------------------------------------------------------
const researchListSrc = extractLines('researchListFromManageModal', 6716, 6946, 'async function researchListFromManageModal(listId, options = {}){');
assert(
...
// the rest.
// ---------------------------------------------------------------------------
const openResearchedSrc = extractLines('openResearchedAccountOpportunities', 8073, 8168, 'async function openResearchedAccountOpportunities(uploadId, accountName){');
assert(
