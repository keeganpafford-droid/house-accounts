...
- **Unattributed purchases are never a fake buying-center row.** Every real category purchase renders in a separate "Account-wide purchases not fully attributed" panel, outside the organizational grid, since no automatic attribution exists under the current truth rule. ("Not fully" rather than "not yet," 2026-08-19: mapping one real intersection later does not prove the category's entire historical purchase volume is now attributed.)
